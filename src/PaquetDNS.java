...
// classe PaquetDNS
// traitement du paquet DNS decapsule d UDP/IP 
...
// ---------------------------------------------------------------|----------------------------------------------------------------
//                         Total questions    Qdcount             |                      Total answers   Ancount
// ---------------------------------------------------------------|----------------------------------------------------------------
//                 Total authority ressource records    Nscount   |      Total additional ressource records    Arcount
// ---------------------------------------------------------------|----------------------------------------------------------------
//                                            Question Section
// ---------------------------------------------------------------|----------------------------------------------------------------
//                                            Answer Section 
...
// todo : reconstitution de paquet tronques (ie protcole UDP + TC=1)

// todo : 

public class PaquetDNS {
    ...
    PaquetDNS ( String[] paquetDNS ){

        // recuperation de l identification
        this.indentification = Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 0, 1, false )), 16 ) ;

        // recuperation de QR et opcode
        this.qr = Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 2, 2, false )), 16 ) >>> 7 ;
        this.opcode = ( Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 2, 2, false )), 16 ) << 17 ) >>> 28 ;

        // recuperation Rcode 
        this.rCode = ( Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 3, 3, false )), 16 ) << 28 ) >>> 28 ;

        // recuperation des differents compteurs
        this.qdCount = Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 4, 5, false )), 16 ) ;
        this.anCount = Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 6, 7, false )), 16 ) ;
        this.nsCount = Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 8, 9, false )), 16 ) ;
        this.arCount = Integer.parseInt( String.join("", Fonctions.extractArray( paquetDNS, 10, 11, false )), 16 ) ;
        
        // recuperation des donnes transportees dans la requete
        this.datasDNS = Fonctions.extractArray( paquetDNS, 12, paquetDNS.length - 1, false) ;
